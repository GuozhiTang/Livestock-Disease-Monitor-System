...
export class AuthService {
  ...
  /**
   * To check the keystore with password when login
   * @param keystore the uploaded keystore file
   * @param password the relevanet password for exact uploaded keystore
   */
